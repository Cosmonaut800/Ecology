...
const light_texture = 0 #preload("res://Materials/Textures/spotlight.png")
...
var light_image := 0 #light_texture.get_image()
...
func _ready():
	...
	fogs[4].set_shader_parameter("srcTex", $SubViewport.get_texture())
...
func world_to_texture_space(position: Vector3) -> Vector2:
	return Vector2(8.0 * position.x + 512.0, 8.0 * position.z + 512.0)
